...
class BTCChina():
    ...
    def _get_params_hash(self, pdict):
        ...
        phash = hmac.new(bytes(self.secret_key, encoding="utf8"), pstring.encode("utf8"), hashlib.sha1).hexdigest()
        return phash
    ...
    def _private_request(self, post_data):
        ...
        # must use b64 encode
        auth_string = 'Basic ' + str(base64.b64encode(self.access_key + ':' + pd_hash), encoding="utf-8")
